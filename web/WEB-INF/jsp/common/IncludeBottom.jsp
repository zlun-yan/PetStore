                        ...
                        <ul class="list-style-none d-flex flex-items-center mb-3 mb-sm-0 lh-condensed-ultra">
                            <li class="mr-3">
                                <a href="https://twitter.com"
                                   title="PetStore on Twitter" style="color: #959da5;">
                            ...
                            <li class="mr-3">
                                <a href="https://www.facebook.com" title="PetStore on Facebook" style="color: #959da5;">
                            ...
                            <li class="mr-3">
                                <a href="https://www.youtube.com" title="PetStore on YouTube" style="color: #959da5;">
                            ...
                            <li class="mr-3 flex-self-start">
                                <a href="https://www.linkedin.com" title="PetStore on Linkedin" style="color: #959da5;">
                            ...
                            <li>
                                <a href="https://github.com/zlun-yan" title="PetStore's organization" style="color: #959da5;">
                                    ...
                                    <span class="sr-only">PetStore</span>
                                </a>
                            </li>
                        </ul>
                        <ul class="list-style-none d-flex flex-wrap text-gray">
                            <li class="mr-3">&copy; 2021 PetStore, Inc.</li>
